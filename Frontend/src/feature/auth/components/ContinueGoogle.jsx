 ...
 * - Official multi-color "G" logo mark
 * - Approved wording ("Continue with Google")
 * - Adequate touch target height, clear focus state, no logo distortion
 *
 * Styled for the SNITCH premium dark theme (neutral dark surface variant,
 * which Google permits alongside the light variant).
 */
const GoogleLogo = () => (
  <svg
